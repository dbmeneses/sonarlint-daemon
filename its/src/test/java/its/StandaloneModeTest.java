...
public class StandaloneModeTest {
  ...
  public void test() throws InterruptedException, IOException {
    ...
    sonarlint.register(createStandaloneConfig());

    AnalysisReq analysisConfig = createAnalysisConfig("java-sample");
  ...
  private static StandaloneConfiguration createStandaloneConfig() {
